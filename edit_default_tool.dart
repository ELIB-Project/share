...
class _editDefaultToolPageState extends State<editDefaultToolPage> {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController _nameController = TextEditingController(text: tool.name);
    TextEditingController _toolExplainController = TextEditingController(text: tool.toolExplain);
