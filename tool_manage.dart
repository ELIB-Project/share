                                ...
                                child: Center(
                                  child: Center(
                                    child: Column(children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 60, bottom: 50, left: 90, right: 90),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Container(
                                            ...
                                            Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async {
                                                  ...
                                                  var dio = await authDio();
                                                  dio.options.headers['Authorization'] = '$accessToken';
                                                  final response = await dio.delete('/api/v1/user/tool/custom', queryParameters: {'id': customTool.id});
