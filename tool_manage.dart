                                                  ...
                                                  child: ListView.builder(
                                                      ...
                                                      itemBuilder: (context, i) {
                                                        ...
                                                        if (snapshot.data?[i].toolExplain == null || snapshot.data?[i].toolExplain =="") {
                                                          ...
                                                          if (toolExplain!.length > 24) {
                                                            toolExplain = toolExplain?.substring(0, 24);
                                                        ...
                                                        String? maker;
                                                        if (snapshot.data?[i].maker == null || snapshot.data?[i].maker =="") {
                                                          maker = "Ad.";
                                                          makerWidth = 40;
                                                          //makerPadding = 0;
                                                        } else {
                                                          maker = snapshot.data?[i].maker;
