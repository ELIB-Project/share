...
double mediaHeight(BuildContext context, double scale) =>
    (MediaQuery.of(context).size.height -  MediaQuery.of(context).padding.top) * scale;
...
class qrDefaultToolPage extends StatefulWidget {
  qrDefaultToolPage({
    Key? key,
    required this.tool,
    required this.count,
  ...
  @override
  State<qrDefaultToolPage> createState() => _qrDefaultToolPageState();
}

class _qrDefaultToolPageState extends State<qrDefaultToolPage> {
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      contentPadding: EdgeInsets.only(
                                          left: 10, bottom: 0, top: boxHeight, right: 5),
                                    ),
                                    style: TextStyle(
                              ...
                              SizedBox(height: mediaHeight(context, 0.04),),
